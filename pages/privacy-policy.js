...
const PrivacyPolicy = () => {
	return (
		<>
			<Head>
				<title>Privacy Policy | Vale Building Services in Kingston Upon Thames, Surrey and London</title>
			...
			<div className='container py-4 pt-5'>
				<h1 className="pt-4">Vale Building Services Privacy Policy</h1>
				<h6 className='pb-4'>This Privacy Policy describes how your personal information is collected, used, and shared when you visit  https://www.valebuildingservices.com/ (the “Site”).</h6>
				...
				<p className='pb-2'>For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e-mail at <a href="mailto:admin@valeinfo.co.uk">admin@valeinfo.co.uk</a> or by mail using the details provided below:</p>
				<p className='pb-2'>Privacy Policy Information, Bendando Ltd, 20 Lindisfarne Road, Wimbledon, London, SW20 0NW</p>
			</div>
		</>
	);
};
